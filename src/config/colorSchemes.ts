...
export const COLOR_SCHEMES: ColorScheme[] = [
  ...
  },
  {
    id: 'black-and-white',
    name: 'Black & White',
    preview: ['#ffffff', '#000000', '#ffffff', '#000000'],
    nodeColors: {
      primary: { fill: '#ffffff', stroke: '#000000', text: '#000000' },
      secondary: { fill: '#ffffff', stroke: '#000000', text: '#000000' },
      accent: { fill: '#000000', stroke: '#000000', text: '#ffffff' },
      success: { fill: '#ffffff', stroke: '#000000', text: '#000000' },
      warning: { fill: '#ffffff', stroke: '#000000', text: '#000000' },
      danger: { fill: '#000000', stroke: '#000000', text: '#ffffff' },
    },
    lineColor: '#000000',
  ...
  },
  {
    id: 'grayscale',
    name: 'Grayscale',
    preview: ['#ffffff', '#9ca3af', '#4b5563', '#1f2937'],
    nodeColors: {
      primary: { fill: '#ffffff', stroke: '#4b5563', text: '#111827' },
      secondary: { fill: '#f3f4f6', stroke: '#6b7280', text: '#1f2937' },
      accent: { fill: '#374151', stroke: '#1f2937', text: '#ffffff' },
      success: { fill: '#e5e7eb', stroke: '#4b5563', text: '#111827' },
      warning: { fill: '#f3f4f6', stroke: '#374151', text: '#1f2937' },
      danger: { fill: '#1f2937', stroke: '#111827', text: '#ffffff' },
    },
    lineColor: '#374151',
    backgroundColor: '#f9fafb',
  },
  {
    id: 'wireframe-transparent',
    name: 'Wireframe (Transparent)',
    preview: ['#ffffff', '#000000', '#ffffff', '#000000'],
    nodeColors: {
      primary: { fill: 'transparent', stroke: '#000000', text: '#000000' },
      secondary: { fill: 'transparent', stroke: '#000000', text: '#000000' },
      accent: { fill: 'transparent', stroke: '#000000', text: '#000000' },
      success: { fill: 'transparent', stroke: '#000000', text: '#000000' },
      warning: { fill: 'transparent', stroke: '#000000', text: '#000000' },
      danger: { fill: 'transparent', stroke: '#000000', text: '#000000' },
    },
    lineColor: '#000000',
